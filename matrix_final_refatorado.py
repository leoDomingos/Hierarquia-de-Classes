...
class CalculadoraMatricial:
    """Calculadora que gerencia matrizes e realiza operações usando Array"""
    
    def __init__(self):
        self.matrizes = Array()
        self.nomes_matrizes = Array()
    ...
    def adicionar_matriz(self, dados: List[List[float]]):
        ...
        self.matrizes.insert_end(matriz)
    ...
    def operacao(self, indice1: int, operador: str, indice2: Union[int, float] = None):
        ...
        try:
            ...
            if operador == '*' and isinstance(indice2, (int, float)):
                return A * indice2
    ...
    def adicionar_matriz_com_nome(self, dados: List[List[float]], nome: str = None):
        ...
        if nome:
            if len(self.nomes_matrizes) <= indice:
                self.nomes_matrizes.insert_end(nome)
            else:
